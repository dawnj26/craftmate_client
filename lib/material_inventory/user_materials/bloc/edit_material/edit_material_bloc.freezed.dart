...
/// @nodoc
abstract class $EditMaterialEventCopyWith<$Res>  {
  factory $EditMaterialEventCopyWith(EditMaterialEvent value, $Res Function(EditMaterialEvent) then) = _$EditMaterialEventCopyWithImpl<$Res, EditMaterialEvent>;
...
/// @nodoc
class _$EditMaterialEventCopyWithImpl<$Res,$Val extends EditMaterialEvent> implements $EditMaterialEventCopyWith<$Res> {
  _$EditMaterialEventCopyWithImpl(this._value, this._then);
...
/// Create a copy of EditMaterialEvent
...
/// @nodoc
class __$$StartedImplCopyWithImpl<$Res> extends _$EditMaterialEventCopyWithImpl<$Res, _$StartedImpl> implements _$$StartedImplCopyWith<$Res> {
...
@override
String toString() {
  return 'EditMaterialEvent.started()';
}
...
abstract class _Started implements EditMaterialEvent {
...
/// @nodoc
class __$$NameChangedImplCopyWithImpl<$Res> extends _$EditMaterialEventCopyWithImpl<$Res, _$NameChangedImpl> implements _$$NameChangedImplCopyWith<$Res> {
...
@override
String toString() {
  return 'EditMaterialEvent.nameChanged(nameText: $nameText)';
}
...
abstract class _NameChanged implements EditMaterialEvent {
...
/// @nodoc
class __$$DescriptionChangedImplCopyWithImpl<$Res> extends _$EditMaterialEventCopyWithImpl<$Res, _$DescriptionChangedImpl> implements _$$DescriptionChangedImplCopyWith<$Res> {
...
@override
String toString() {
  return 'EditMaterialEvent.descriptionChanged(descriptionText: $descriptionText)';
}
...
abstract class _DescriptionChanged implements EditMaterialEvent {
...
/// @nodoc
class __$$QuantityChangedImplCopyWithImpl<$Res> extends _$EditMaterialEventCopyWithImpl<$Res, _$QuantityChangedImpl> implements _$$QuantityChangedImplCopyWith<$Res> {
...
@override
String toString() {
  return 'EditMaterialEvent.quantityChanged(quantity: $quantity)';
}
...
abstract class _QuantityChanged implements EditMaterialEvent {
...
/// @nodoc
class __$$ImagePathUploadedImplCopyWithImpl<$Res> extends _$EditMaterialEventCopyWithImpl<$Res, _$ImagePathUploadedImpl> implements _$$ImagePathUploadedImplCopyWith<$Res> {
...
@override
String toString() {
  return 'EditMaterialEvent.imageUploaded(imagePath: $imagePath)';
}
...
abstract class _ImagePathUploaded implements EditMaterialEvent {
...
/// @nodoc
class __$$SubmitImplCopyWithImpl<$Res> extends _$EditMaterialEventCopyWithImpl<$Res, _$SubmitImpl> implements _$$SubmitImplCopyWith<$Res> {
...
@override
String toString() {
  return 'EditMaterialEvent.submit()';
}
...
abstract class _Submit implements EditMaterialEvent {
...
/// @nodoc
class __$$CategorySelectedImplCopyWithImpl<$Res> extends _$EditMaterialEventCopyWithImpl<$Res, _$CategorySelectedImpl> implements _$$CategorySelectedImplCopyWith<$Res> {
...
@override
String toString() {
  return 'EditMaterialEvent.categorySelected(categoryId: $categoryId)';
}
...
abstract class _CategorySelected implements EditMaterialEvent {
...
abstract class _$$ResetImplCopyWith<$Res>  {
  factory _$$ResetImplCopyWith(_$ResetImpl value, $Res Function(_$ResetImpl) then) = __$$ResetImplCopyWithImpl<$Res>;
...
/// @nodoc
class __$$ResetImplCopyWithImpl<$Res> extends _$EditMaterialEventCopyWithImpl<$Res, _$ResetImpl> implements _$$ResetImplCopyWith<$Res> {
...
@override
String toString() {
  return 'EditMaterialEvent.reset()';
}
...
abstract class _Reset implements EditMaterialEvent {
...
/// Create a copy of EditMaterialState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
$EditMaterialStateCopyWith<EditMaterialState> get copyWith => throw _privateConstructorUsedError;

}

/// @nodoc
abstract class $EditMaterialStateCopyWith<$Res>  {
  factory $EditMaterialStateCopyWith(EditMaterialState value, $Res Function(EditMaterialState) then) = _$EditMaterialStateCopyWithImpl<$Res, EditMaterialState>;
@useResult
$Res call({
...
/// @nodoc
class _$EditMaterialStateCopyWithImpl<$Res,$Val extends EditMaterialState> implements $EditMaterialStateCopyWith<$Res> {
  _$EditMaterialStateCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$InitialImplCopyWith<$Res> implements $EditMaterialStateCopyWith<$Res> {
...
/// @nodoc
class __$$InitialImplCopyWithImpl<$Res> extends _$EditMaterialStateCopyWithImpl<$Res, _$InitialImpl> implements _$$InitialImplCopyWith<$Res> {
...
class _$InitialImpl  implements Initial {
  const _$InitialImpl({this.name = const MaterialName.pure(), this.description = const MaterialDescription.pure(), this.category = const MaterialCategoryDropdown.pure(), this.quantity = 1, final  List<MaterialCategory> categories = const [], this.imagePath}): _categories = categories;
...
@override
String toString() {
  return 'EditMaterialState.initial(name: $name, description: $description, category: $category, quantity: $quantity, categories: $categories, imagePath: $imagePath)';
}
...
abstract class Initial implements EditMaterialState {
...
/// @nodoc
abstract class _$$LoadingImplCopyWith<$Res> implements $EditMaterialStateCopyWith<$Res> {
...
/// @nodoc
class __$$LoadingImplCopyWithImpl<$Res> extends _$EditMaterialStateCopyWithImpl<$Res, _$LoadingImpl> implements _$$LoadingImplCopyWith<$Res> {
...
class _$LoadingImpl  implements Loading {
  const _$LoadingImpl({this.name = const MaterialName.pure(), this.description = const MaterialDescription.pure(), this.category = const MaterialCategoryDropdown.pure(), this.quantity = 1, final  List<MaterialCategory> categories = const [], this.imagePath}): _categories = categories;
...
@override
String toString() {
  return 'EditMaterialState.loading(name: $name, description: $description, category: $category, quantity: $quantity, categories: $categories, imagePath: $imagePath)';
}
...
abstract class Loading implements EditMaterialState {
...
/// @nodoc
abstract class _$$NormalImplCopyWith<$Res> implements $EditMaterialStateCopyWith<$Res> {
...
/// @nodoc
class __$$NormalImplCopyWithImpl<$Res> extends _$EditMaterialStateCopyWithImpl<$Res, _$NormalImpl> implements _$$NormalImplCopyWith<$Res> {
...
class _$NormalImpl  implements Normal {
  const _$NormalImpl({this.name = const MaterialName.pure(), this.description = const MaterialDescription.pure(), this.category = const MaterialCategoryDropdown.pure(), this.quantity = 1, final  List<MaterialCategory> categories = const [], this.imagePath}): _categories = categories;
...
@override
String toString() {
  return 'EditMaterialState.normal(name: $name, description: $description, category: $category, quantity: $quantity, categories: $categories, imagePath: $imagePath)';
}
...
abstract class Normal implements EditMaterialState {
...
/// @nodoc
abstract class _$$ChangedImplCopyWith<$Res> implements $EditMaterialStateCopyWith<$Res> {
...
/// @nodoc
class __$$ChangedImplCopyWithImpl<$Res> extends _$EditMaterialStateCopyWithImpl<$Res, _$ChangedImpl> implements _$$ChangedImplCopyWith<$Res> {
...
class _$ChangedImpl  implements Changed {
  const _$ChangedImpl({this.name = const MaterialName.pure(), this.description = const MaterialDescription.pure(), this.category = const MaterialCategoryDropdown.pure(), this.quantity = 1, final  List<MaterialCategory> categories = const [], this.imagePath}): _categories = categories;
...
@override
String toString() {
  return 'EditMaterialState.changed(name: $name, description: $description, category: $category, quantity: $quantity, categories: $categories, imagePath: $imagePath)';
}


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _$ChangedImpl&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.category, category) || other.category == category)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&const DeepCollectionEquality().equals(other._categories, _categories)&&(identical(other.imagePath, imagePath) || other.imagePath == imagePath));
}
...
abstract class Changed implements EditMaterialState {
  const factory Changed({final  MaterialName name, final  MaterialDescription description, final  MaterialCategoryDropdown category, final  int quantity, final  List<MaterialCategory> categories, final  String? imagePath}) = _$ChangedImpl;
...
/// @nodoc
abstract class _$$UploadingImplCopyWith<$Res> implements $EditMaterialStateCopyWith<$Res> {
...
/// @nodoc
class __$$UploadingImplCopyWithImpl<$Res> extends _$EditMaterialStateCopyWithImpl<$Res, _$UploadingImpl> implements _$$UploadingImplCopyWith<$Res> {
...
class _$UploadingImpl  implements Uploading {
  const _$UploadingImpl({this.name = const MaterialName.pure(), this.description = const MaterialDescription.pure(), this.category = const MaterialCategoryDropdown.pure(), this.quantity = 1, final  List<MaterialCategory> categories = const [], this.imagePath}): _categories = categories;
...
@override
String toString() {
  return 'EditMaterialState.uploading(name: $name, description: $description, category: $category, quantity: $quantity, categories: $categories, imagePath: $imagePath)';
}
...
abstract class Uploading implements EditMaterialState {
...
/// @nodoc
abstract class _$$UploadedImplCopyWith<$Res> implements $EditMaterialStateCopyWith<$Res> {
...
/// @nodoc
class __$$UploadedImplCopyWithImpl<$Res> extends _$EditMaterialStateCopyWithImpl<$Res, _$UploadedImpl> implements _$$UploadedImplCopyWith<$Res> {
...
class _$UploadedImpl  implements Uploaded {
  const _$UploadedImpl({this.name = const MaterialName.pure(), this.description = const MaterialDescription.pure(), this.category = const MaterialCategoryDropdown.pure(), this.quantity = 1, final  List<MaterialCategory> categories = const [], this.imagePath}): _categories = categories;
...
@override
String toString() {
  return 'EditMaterialState.uploaded(name: $name, description: $description, category: $category, quantity: $quantity, categories: $categories, imagePath: $imagePath)';
}
...
abstract class Uploaded implements EditMaterialState {
...
/// @nodoc
abstract class _$$SuccessImplCopyWith<$Res> implements $EditMaterialStateCopyWith<$Res> {
...
/// @nodoc
class __$$SuccessImplCopyWithImpl<$Res> extends _$EditMaterialStateCopyWithImpl<$Res, _$SuccessImpl> implements _$$SuccessImplCopyWith<$Res> {
...
class _$SuccessImpl  implements Success {
  const _$SuccessImpl({this.name = const MaterialName.pure(), this.description = const MaterialDescription.pure(), this.category = const MaterialCategoryDropdown.pure(), this.quantity = 1, final  List<MaterialCategory> categories = const [], this.imagePath}): _categories = categories;
...
@override
String toString() {
  return 'EditMaterialState.success(name: $name, description: $description, category: $category, quantity: $quantity, categories: $categories, imagePath: $imagePath)';
}
...
abstract class Success implements EditMaterialState {
  const factory Success({final  MaterialName name, final  MaterialDescription description, final  MaterialCategoryDropdown category, final  int quantity, final  List<MaterialCategory> categories, final  String? imagePath}) = _$SuccessImpl;
...
/// @nodoc
abstract class _$$ErrorImplCopyWith<$Res> implements $EditMaterialStateCopyWith<$Res> {
  factory _$$ErrorImplCopyWith(_$ErrorImpl value, $Res Function(_$ErrorImpl) then) = __$$ErrorImplCopyWithImpl<$Res>;
@override @useResult
$Res call({
 String message, MaterialName name, MaterialDescription description, MaterialCategoryDropdown category, int quantity, String? imagePath, List<MaterialCategory> categories
});
...
/// @nodoc
class __$$ErrorImplCopyWithImpl<$Res> extends _$EditMaterialStateCopyWithImpl<$Res, _$ErrorImpl> implements _$$ErrorImplCopyWith<$Res> {
...
/// Create a copy of EditMaterialState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? message = null,Object? name = null,Object? description = null,Object? category = null,Object? quantity = null,Object? imagePath = freezed,Object? categories = null,}) {
...
as MaterialDescription,category: null == category ? _value.category : category // ignore: cast_nullable_to_non_nullable
as MaterialCategoryDropdown,quantity: null == quantity ? _value.quantity : quantity // ignore: cast_nullable_to_non_nullable
as int,imagePath: freezed == imagePath ? _value.imagePath : imagePath // ignore: cast_nullable_to_non_nullable
...
class _$ErrorImpl  implements Error {
  const _$ErrorImpl(this.message, {this.name = const MaterialName.pure(), this.description = const MaterialDescription.pure(), this.category = const MaterialCategoryDropdown.pure(), this.quantity = 1, this.imagePath, final  List<MaterialCategory> categories = const []}): _categories = categories;
...
@override
String toString() {
  return 'EditMaterialState.error(message: $message, name: $name, description: $description, category: $category, quantity: $quantity, imagePath: $imagePath, categories: $categories)';
}


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _$ErrorImpl&&(identical(other.message, message) || other.message == message)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.category, category) || other.category == category)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.imagePath, imagePath) || other.imagePath == imagePath)&&const DeepCollectionEquality().equals(other._categories, _categories));
}


@override
int get hashCode => Object.hash(runtimeType,message,name,description,category,quantity,imagePath,const DeepCollectionEquality().hash(_categories));
...
abstract class Error implements EditMaterialState {
  const factory Error(final  String message, {final  MaterialName name, final  MaterialDescription description, final  MaterialCategoryDropdown category, final  int quantity, final  String? imagePath, final  List<MaterialCategory> categories}) = _$ErrorImpl;
  

  

 String get message;@override MaterialName get name;@override MaterialDescription get description;@override MaterialCategoryDropdown get category;@override int get quantity;@override String? get imagePath;@override List<MaterialCategory> get categories;
/// Create a copy of EditMaterialState
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
