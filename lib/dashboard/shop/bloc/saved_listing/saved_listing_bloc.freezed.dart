...
$SavedListingEventCopyWith<SavedListingEvent> get copyWith => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class _$$StartedImplCopyWith<$Res> implements $SavedListingEventCopyWith<$Res> {
...
@override
String toString() {
  return 'SavedListingState.initial(query: $query)';
}
...
@override
String toString() {
  return 'SavedListingState.loading(query: $query)';
}
...
@override
String toString() {
  return 'SavedListingState.loaded(query: $query)';
}
...
@override
String toString() {
  return 'SavedListingState.error(message: $message, query: $query)';
}
